...
var sttv = {
	stripe: _config2.default[_config2.default.env].stripe,
	resources: {
...
while (_loader2.default.length) {
    _loader2.default.shift().call(undefined, _jquery2.default);
}
...
var _checkout = __webpack_require__(17);
...
var _readMore = __webpack_require__(21);

var _readMore2 = _interopRequireDefault(_readMore);

var _menuToggle = __webpack_require__(22);
...
var events = [_checkout2.default, _contact2.default, _login2.default, _menuToggle2.default, _modal2.default, _readMore2.default, _scroller2.default, _subscribe2.default];
