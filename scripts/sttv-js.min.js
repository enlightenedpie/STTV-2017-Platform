...
var _checkout = __webpack_require__(1);
      ...
      t.validate(function (creds) {
        _st.request({
          ...
          success: function success(d) {
            ...
            if (d.code === 'login_fail') errFlag.innerHTML = d.message;else window.location.href = t.redirected || _st.resources.app;
          },
          error: function error(err) {
            console.log(err);
          }
...
var _parseParams = __webpack_require__(9);

var _parseParams2 = _interopRequireDefault(_parseParams);

var _menuToggle = __webpack_require__(10);

var _menuToggle2 = _interopRequireDefault(_menuToggle);

var _dismiss = __webpack_require__(11);
...
(0, _jquery2.default)(document).ready(function () {
    ...
    (0, _jquery2.default)('.dropdown-trigger').dropdown();
});

(0, _jquery2.default)(document).on('click', '.login-modal', function (e) {
    e.preventDefault();
