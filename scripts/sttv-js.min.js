...
var Checkout = function () {
		...
		value: function render(el) {
			...
			if (t.index === 0) {
				t.html.forEach(function (l, i) {
					...
					t.html[i] = l.replace(/({{)(.*)(}})/g, function (match, p1, p2, p3) {
						return t.totals[p2];
					});
				});
				t.index++;
   ...
   this.update() */
		...
		key: 'validate',
		value: function validate(inputs, context, extra) {
